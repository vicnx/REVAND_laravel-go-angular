...
import { SubscriptionsClientEditorComponent} from './subscriptions-client-editor.component'
// import { Award, AwardsService } from '../../../assets/logo-web.png';

@Component({
  selector: 'app-subscriptionsclient-preview',
  styleUrls: ['subscriptions-client-preview.component.css'],
  templateUrl: './subscriptions-client-preview.component.html'
})
export class SubscriptionsClientPreviewComponent{
